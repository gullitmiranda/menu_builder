...
With this gem/plugin you get a helper to define menus and also can control the active item of menu
...
like below:
  ...
  <head>
    <style type="text/css" charset="utf-8">
      ...
      #header #active a { background-position:0% -43px; }
      #header #active a span { background-position:100% -43px; }
    </style>
  </head>
